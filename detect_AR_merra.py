...
YEAR=2017
TIME_START = '%d-04-01 00:00:00' %YEAR
TIME_END   = '%d-04-30 23:00:00' %YEAR

#==== Import data = =================
uq_file = os.path.join('.', '2017_april.nc')
vq_file = os.path.join('.', '2017_april.nc')

#==== ivt reconstruction and anomalies ===================
ivt_file = os.path.join('.', 'ivt_bc_2017_april-THR-kernel-april-t120-s2.nc') #save nc file in given name
#------------------Output folder------------------
...
#==== Read in data ===============
uflux=funcs.readNC(uq_file, 'BCFLUXU')
vflux=funcs.readNC(vq_file, 'BCFLUXV')
